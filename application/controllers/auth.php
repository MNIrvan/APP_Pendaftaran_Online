...
class auth extends CI_Controller
{
    ...
    private function _sendEmail($token, $type)
    {
        ...
        $this->email->from('mni110804@gmail.com', 'Muhammad Nuril Irvan');
    ...
    public function changePassword()
    {
        ...
        $this->session->set_flashdata('message', '<div class="alert alert-success" role="alert">Password has been changed! Please email.</div');
        redirect('alert');
        }    
